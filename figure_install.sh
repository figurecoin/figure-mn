...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='figure.conf'
CONFIGFOLDER='/root/.figurecore'
COIN_DAEMON='figured'
COIN_CLI='figure-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/figurecoin/figurecoin/releases/download/0.12.1/binaries.tar.gz'
...
addnode=188.225.75.13
addnode=188.225.75.6
addnode=188.225.75.9
addnode=188.225.75.12
addnode=188.225.75.11
addnode=188.225.76.249
EOF
}
